...
const commandMap = {
	'get-process': 'Get-Process | Sort-Object -Descending CPU | Select-Object -First 40 -Property Id, Handles, Handle, Name, Description, CPU, NPM, PM, SI, VM, WS, Size, Path | ConvertTo-Json -Compress',
						...
						<ul className="navbar-nav mr-auto">
							<li className="nav-item dropdown">
								...
								<div className="dropdown-menu" aria-labelledby="navbarDropdown">
									<span className="dropdown-item" data-command='get-process'
										onClick={this.handleCommandChange}>
										Processes and Performance
									</span>
									{/* <a className="dropdown-item" href="signup.html"> */}
									<span className="dropdown-item" data-command='get-cpu'
										onClick={this.handleCommandChange}>
										CPU
									</span>
									{/* <a className="dropdown-item" href="signup.html"> */}
									<span className="dropdown-item" data-command='get-memory'
										onClick={this.handleCommandChange}>
										Memory
									</span>
									{/* <a className="dropdown-item" href="signup.html"> */}
									<span className="dropdown-item" data-command='get-wifi'
										onClick={this.handleCommandChange}>
										WiFi
									</span>
									{/* <a className="dropdown-item" href="signup.html"> */}
									<span className="dropdown-item" data-command='get-gpu'
										onClick={this.handleCommandChange}>
										GPU
									</span>
								</div>
							...
							<li className="nav-item dropdown">
								...
								<div className="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<span className="dropdown-item" data-command='get-dns'
										onClick={this.handleCommandChange}>
										DNS History
									...
									{/* <a className="dropdown-item" href="signup.html"> */}
									<span className="dropdown-item" data-command='get-network'
										onClick={this.handleCommandChange}>
										Current Network
									</span>
								</div>
							...
							<li className="nav-item dropdown">
								...
								<div className="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<span className="dropdown-item" data-command='get-chrome'
										onClick={this.handleCommandChange}>
										Chrome
										</span>
									{/* <a className="dropdown-item" href="signup.html"> */}
									<span className="dropdown-item" data-command='get-vscode'
										onClick={this.handleCommandChange}>
										Visual Studio Code
										</span>

									<span className="dropdown-item" data-command='get-slack'
										onClick={this.handleCommandChange}>
										Slack
										</span>

									<span className="dropdown-item" data-command='get-custom'
										onClick={this.handleCommandChange}>
										Custom Script
										</span>
									...
									<span className="dropdown-item" data-command='get-restart'
										onClick={this.handleCommandChange}>
										Restart
										</span>
									<span className="dropdown-item" data-command='get-network'
							...
							<li className="nav-item dropdown">
								...
								<div className="dropdown-menu" aria-labelledby="navbarDropdown">
									{/* <a className="dropdown-item" href="signup.html">
								 */}
									<span className="dropdown-item" data-command='get-device'
										onClick={this.handleCommandChange}>
